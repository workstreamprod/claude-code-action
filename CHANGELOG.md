...
## Fork Changes (workstreamprod/claude-code-action@beta)
...
- **Updated Base Action**: Uses `workstreamprod/claude-code-base-action@beta` which includes OAuth credential handling
